...
describe("ChevronIcon", () => {
  it("renders correctly", () => {
    // act
    const tree = rendeder
      .create(<ChevronIcon className="test-class" clickHandler={() => {}} />)
      .toJSON();
  ...
  it("renders the icon with given class name", () => {
    ...
    const { getByTestId } = render(
      <ChevronIcon className="test-class" clickHandler={() => {}} />,
    );
  ...
  it("invokes the click handler when clicked", () => {
    ...
    // act
    const { getByTestId } = render(
      <ChevronIcon className="test-class" clickHandler={clickHandler} />,
    );
