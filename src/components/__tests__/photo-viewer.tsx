...
describe('PhotoViewer component', () => {
  ...
  it("renders correctly", () => {
    // act
    const tree = rendeder.create(<PhotoViewer isVisible={true} src={src} closeHandler={() => { }} />).toJSON();
  ...
  it('renders the component when isVisible is true', () => {
    // act
    const { getByTestId } = render(<PhotoViewer isVisible={true} src={src} closeHandler={() => { }} />);
  ...
  it('does not render the component when isVisible is false', () => {
    // act
    const { queryByTestId } = render(<PhotoViewer isVisible={false} src={src} closeHandler={() => { }} />);
  ...
  it('calls the close handler when the close button is clicked', () => {
    ...
    // act
    const { getByTestId } = render(<PhotoViewer isVisible={true} src={src} closeHandler={closeHandler} />);
